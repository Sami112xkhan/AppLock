package com.samikhan.applock.features.settings.ui
...
import com.samikhan.applock.core.broadcast.DeviceAdmin
import com.samikhan.applock.core.navigation.Screen
import com.samikhan.applock.core.utils.hasUsagePermission
import com.samikhan.applock.core.utils.isAccessibilityServiceEnabled
import com.samikhan.applock.core.utils.openAccessibilitySettings
...
import com.samikhan.applock.services.ExperimentalAppLockService
import com.samikhan.applock.services.ShizukuAppLockService
import com.samikhan.applock.ui.icons.Accessibility
import com.samikhan.applock.ui.icons.BrightnessHigh
import com.samikhan.applock.ui.icons.Fingerprint
import com.samikhan.applock.ui.icons.FingerprintOff
import com.samikhan.applock.ui.icons.Github
import com.samikhan.applock.ui.icons.Timer
...
fun SettingsScreen(
    ...
    val biometricAuthManager = remember { BiometricAuthManager(context, appLockRepository) }

    val isBiometricAvailable = remember {
        biometricAuthManager.checkBiometricAvailability() == BiometricAuthManager.BiometricAvailability.AVAILABLE
    }
    ...
    if (showDialog) {
        AlertDialog(
            ...
            text = { Text("Hi, I'm Sami, the developer of App Lock. I'm a student developer passionate about creating useful apps. If you find it helpful, please consider supporting its development with a small donation. Any amount is greatly appreciated and helps me continue to improve the app and work on new features. Thank you for your support!") },
            confirmButton = {
                FilledTonalButton(
                    onClick = {
                        context.startActivity(
                            Intent(
                                Intent.ACTION_VIEW,
                                "https://paypal.me/SamiKhan112".toUri()
                            )
                        )
                        showDialog = false
                    }
                ...
                ElevatedCard(
                    ...
                    Column {
                        ...
                        ActionSettingItem(
                            ...
                            title = "Debug Biometric",
                            description = "Test biometric authentication and view diagnostic info",
                            onClick = {
                                val diagnosticInfo = biometricAuthManager.getDiagnosticInfo()
                                Log.d("SettingsScreen", diagnosticInfo)
                                Toast.makeText(context, "Check logs for diagnostic info", Toast.LENGTH_LONG).show()
                            }
                        )
                    }
                }
                        ...
                        ActionSettingItem(
                            ...
                            onClick = {
                                context.startActivity(
                                    Intent(
                                        Intent.ACTION_VIEW,
                                        "https://github.com/Sami112xkhan".toUri()
                                    )
                                )
                            })
                    }
